...
12. **Clusters are heuristic.** k-means silhouette is 0.07; clusters are reading aids, not occupational categories.
...
15. **Collection terms.** The audit of 2026-09-16 found that all five posting sources restrict automated extraction in their terms (docs/legal-and-publication-audit.md). The dataset is a one-off private research collection; the repository does not claim that it can be refreshed the same way (DECISION_LOG D-013).
